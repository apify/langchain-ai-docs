...
import IntegrationDownloads from '/snippets/oss/python-retrievers-downloads.mdx';
...
|-----------|---------|---------|
| [`ApifySearchRetriever`](/oss/python/integrations/retrievers/apify_search) | Internet search via the [Apify RAG Web Browser](https://apify.com/apify/rag-web-browser) | [`langchain-apify`](https://pypi.org/project/langchain-apify/) |
